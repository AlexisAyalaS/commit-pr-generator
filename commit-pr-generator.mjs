...
ensure to include relevant emojis at the start, a title describing the changes. Do not include 'Related Issues' or 'Checklist': 
`;
...
const { openUrl } = await inquirer.prompt([
    {
        ...
        choices: [
            ...
            { name: 'DeepSeek', value: 'https://chat.deepseek.com'},
